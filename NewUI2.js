...
//Settings:
    ...
    createSetting('EmergencyNurseries', 'Allow nurseries up to nursery cap if we are on a valid spire even if we have not reached first nursery allowed zone yet.', 'boolean', true, null, "Settings");
