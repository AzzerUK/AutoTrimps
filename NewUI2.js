...
//genBTC advanced settings - option buttons.
    ...
    createSetting('EmergencyNurseries', 'Allow Spire Nurseries', 'Allow nurseries up to nursery cap if we are on a valid spire even if we have not reached first nursery allowed zone yet.', 'boolean', true, null, 'genBTC');
