...
//GEAR:
    ...
    createSetting('EmergencySpireGear', 'Spire Higher Gear', 'Allow gear to be capped higher on valid spires but not outside or after the spire.', 'boolean', true, null, 'Gear');
...
//genBTC advanced settings - option buttons.
    ...
    createSetting('EmergencyNurseries', 'Early Spire Nurseries', 'Allow nurseries up to nursery cap if we are on a valid spire even if we have not reached first nursery allowed zone yet.', 'boolean', true, null, 'genBTC');
